...
//$ip = $this->db->get_where('info_pria',array('id_acara_resepsi='=>'$id_acara_resepsi'))
//->result_array();
//$iw = $this->db->get_where('info_wanita')
//->result_array();
//$ls = $this->db->get_where('love_story')
//->result_array();
...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <title><?= $ip['nama_lengkap']?> and Jane's Wedding</title>
    <link rel="stylesheet" type="text/css" href="<?=base_url('Template-1/')?>theme.css"> 
    <link rel="stylesheet" type="text/css" href="<?=base_url('Template-1/')?>./icons/css/all.min.css"> 
