            ...
            <div class="col col-md-12">
               <div class="card mt-2 ml-2 mr-2">
                    ...
                    <?php foreach($list_tamu as $lt):?>
                      <form id="Form_tamu" action="<?= base_url('tamu/edit') ?>" method="post">
                      <input type="hidden" class="form-control" id="id_tamu" name="id_tamu" style="width:350px;" value= <?=$id_tamu?>>
                          ...
                          <div class="form-group">
                              ...
                              <select class="form-control" id="input_kategori_tamu" name="input_kategori_tamu" style="width:350px;">
                                  ...
                                  <?php foreach ($list_kategori as $k):?>
                                      <?php if( $lt['kategori_meja'] == $k['kategori_meja']):?>
                      ...
                      <button type="submit" name="submit_button" value="simpan_data" class="button_neon button-1"> Ubah Tamu</button>
