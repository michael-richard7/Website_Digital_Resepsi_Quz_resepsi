...
<link rel="stylesheet" href="<?= base_url('back-end/'); ?>plugins/template/css/temp3.min.css">
...
<div id="myModel" class="modal fade" role="dialog">
        ...
        <div class="background">               
                ...
                <?php endforeach; ?>
            <div class="gambar_depan"><img src="<?=base_url('front-end/images/gambar_cover/cover_template5.jpg')?>" alt id="gambar_cover">
            </div>
...
<body id="home">
    ...
    <script>
      ...
      var countdownInterval = setInterval(function() {
        ...
        <section class="couple section-padding parallax-flower" data-bg-image-top="<?=base_url('front-end/images/img-support/tb/')?>b5.jpg" id="couple" style ="background-size:cover">
            <div class="container">
        ...
        <section class="gallery section-padding parallax-flower" data-bg-image-top="<?=base_url('front-end/images/img-support/tb/')?>b5.jpg" id="story" style ="background-size:cover">
                <!-- Start Story -->
        ...
        <!-- start events -->
        <section class="gallery section-padding parallax-flower" data-bg-image-top="<?=base_url('front-end/images/img-support/tb/')?>b5.jpg" id="events" style ="background-size:cover">
                ...
                <div class="row">
                    <div class="col col-md-8 col-md-offset-2">
                        <div class="bquotes-slider">
                            <div class="item">
                            <div class="text">
                                    <p>"Perjalanan Baru Dimulai Untuk Saling Mengasihi Dan Menyayangi Satu Sama Lain."</p>
                                </div>
                                <div class="footer">
                                    <p>- Quz -</p>
                                </div>
        ...
        <!-- start gallery -->
        <section class="gallery section-padding parallax-flower" data-bg-image-top="<?=base_url('front-end/images/img-support/tb/')?>b5.jpg" id="gallery" style ="background-size:cover">
           <div class="container">
                <div class="row section-title">
                    <div class="title-box">
                        <div class="double-line double-line-top">
        ...
        <!-- start of QR-CODE -->
        <section class="gallery section-padding parallax-flower" data-bg-image-top="<?=base_url('front-end/images/img-support/tb/')?>b5.jpg"  id="qr_code" style ="background-size:cover">
        <div class="container">
            <div class="row section-title">
                <div class="title-box">
                    <div class="double-line double-line-top">
        ...
        <!-- start gift-registry -->
        <section class="gift-registry section-padding" id="gift" style="background-image:url(<?=base_url('front-end/images/img-support/tb/')?>b5.jpg); background-size:cover;">
            <div class="container">
                <div class="row section-title">
                    <div class="title-box">
                        <div class="double-line double-line-top">
